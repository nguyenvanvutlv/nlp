...
from keras.layers import Conv1D, Concatenate, Lambda
...
class BERT():
    def __init__(self):
        ...
        self.model = load_trained_model_from_checkpoint(config_path, checkpoint_path, seq_len=256, output_layer_num=4,
                                                        trainable=True)
